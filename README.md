...
**Схема: Интернет → Cloudflare (или аналог) → Фаервол → Балансировщик → Серверы → База данных → Мониторинг**
...
**Облачный фильтр: Cloudflare (Free Tier или аналог)**  
- 🔒 SSL/TLS-шифрование  
...
- **Zabbix, Prometheus + Grafana** — нагрузка и активность  
...
## 1. Облачный фильтр (Cloudflare или аналог):
